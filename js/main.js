...
const projectData = [
  {
    ...
    subTitle:
      "Developed a production-ready MERN stack job portal serving 300+ users, supporting role-based\n" +
        "functionality for recruiters and job seekers. ",
    thumbnail: "../img/thumbnails/Job_Portal_Web_App.png",
    description:
      "I developed a production-ready MERN stack job portal serving over 300 users, featuring role-based access for recruiters and job seekers. The platform includes JWT authentication and dedicated dashboards, reducing access issues by 70%. I designed a responsive React.js interface with real-time job search and category-based filtering, boosting job applications by 50%. The portal was deployed using Render with CI/CD, ensuring smooth updates and 99.9% uptime.",

    techStack: ["MERN"],
    srcURL: "https://jobportal-0b9d.onrender.com/",
  },
  {
    title: "Live-Code-Share",
    subTitle: "Developed a real-time collaborative code editor using the MERN stack and Socket.IO, enabling\n" +
        "seamless multi-user coding sessions with zero-lag interaction.",
    thumbnail: "../img/thumbnails/Live_Code_Share.png",
    description:
      "I developed a real-time collaborative code editor using the MERN stack and Socket.IO, enabling smooth multi-user coding sessions with zero-lag interaction. The platform supports over 100 concurrent users through live code synchronization, unique session ID generation, and temporary in-memory session handling. Leveraging Socket.IO reduced code sync latency by 85%. I also optimized backend event handling using Node.js and Express to ensure stable performance.",
    techStack: ["React.js", "Socket.io"],
    srcURL: "https://live-code-share.vercel.app/",
  },
  {
    title: "Stay-Finder",
    subTitle:
      "Built a full-stack accommodation marketplace using MERN Stack, featuring 200+ property listings.",
    thumbnail: "../img/thumbnails/Stay_Finder.png",
    description:
      "I built a full-stack accommodation marketplace using the MERN stack, showcasing over 200 property listings. The platform supports secure user authentication and authorization via JWT, handling 500+ monthly logins. I integrated Cloudinary for seamless media uploads, enabling storage of 1,000+ images and videos. Following Agile practices, I achieved 95% task completion and boosted feature delivery speed by 25%.",
    techStack: ["MERN"],
    srcURL: "https://stay-finder-five.vercel.app/",
  },
    ...
    elem.innerHTML = buildTemplate(
      `<div class='projects-header'>
       ...
       <div class="card-buttons">
          <a href="https://github.com/abhaysoni0926" target="_blank" class="card-btn" style="float: right; height: 2.35rem; color: #fff; background-color: #68d372; padding: .375rem .75rem; border-radius: .25rem;"><i class="fa-regular fa-file-code"></i>Source Code</a>
